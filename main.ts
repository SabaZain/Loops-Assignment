...
let isUserGuessCorrect:boolean = false;
// Step 4. Simulate user guesses: Use an array to store a series of predefined guesses.
let userGuesses:number[] = [1,2,5,8,10,12,13,15,18,20,21,22,23,29,31,34,38,40,41,44,46,47,48,49,50];
...
while(!isUserGuessCorrect && index < userGuesses.length){
    let userGuessedNumber:number = userGuesses[index];
